# Operator Quickstart — Educational support activities

Shortest path from clone to a verified local dry-run for **ISIC 8550** (`cloud-itonami-isic-8550`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-8550.git
cd cloud-itonami-isic-8550
```
...
- Blueprint governor key: `support-services-governor`
- Likely source path: `edsupport.governor.cljc`
